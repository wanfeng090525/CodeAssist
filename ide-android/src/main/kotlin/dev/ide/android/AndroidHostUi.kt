...
/**
 * Small, self-contained host helpers split out of [MainActivity]: the "Save As" document contract, the
 * source-root search, and the boot splash. None of them belong to the activity's lifecycle, so they live here
 * to keep [MainActivity] to bootstrap + the Compose host.
 */
